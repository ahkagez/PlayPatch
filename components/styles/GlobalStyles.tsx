  ...
  return (
    <style>{`
      * { box-sizing: border-box; }
      ...
      .foco-btn:hover { background: var(--yt-hover-strong); }
      ...
      .foco-colorbox {
        ...
        box-shadow: inset 0 0 0 1px var(--yt-ring);
        transition: box-shadow ${duration.base} ease, transform ${duration.base} ease;
      }
      .foco-colorbox:hover { box-shadow: inset 0 0 0 1px var(--yt-ring-strong); }
      ...
      .foco-range::-webkit-slider-runnable-track {
        ...
        background: linear-gradient(to right,
          ...
          var(--yt-track) var(--foco-fill, 0%), var(--yt-track) 100%);
      }
      ...
      .foco-range::-moz-range-track { height: 4px; border-radius: 999px; background: var(--yt-track); border: none; }
      ...
      ::-webkit-scrollbar-thumb { background: var(--yt-scrollbar); border-radius: ${radius.sm}px; }
      ::-webkit-scrollbar-thumb:hover { background: var(--yt-scrollbar-strong); }
